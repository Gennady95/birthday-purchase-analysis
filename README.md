...
1. Connects to a SQL database and loads customer and order data
2. Cleans and standardizes phone numbers
3. Aggregates customer visits
4. Matches visits with customer birthdays
5. Calculates key metrics:

   * Visits on birthday
   * Visits within 7 days after birthday
6. Sends a Telegram notification after execution
